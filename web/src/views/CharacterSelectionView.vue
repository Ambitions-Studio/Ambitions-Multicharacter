  ...
  >
                  ...
                  <div class="flex-1">
                    <template v-if="!slot.isEmpty && slot.character">
                      ...
                      <p class="text-sm text-slate-300 mb-1">
                        ...
                        <template v-if="slot.character.jobGrade">
                          - {{ slot.character.jobGrade }}</template
                        >
                      </p>
                      <p class="text-sm text-slate-300 mb-1">
                    ...
                    <template v-else>
                      <h3 class="text-lg font-semibold text-slate-400 mb-1">
                        {{ t('characterSelection.slot', { id: slot.id }) }}
                      </h3>
        ...
        >
          <div class="space-y-4">
            <div class="flex items-center space-x-3 mb-6 justify-end">
              <span
                class="text-slate-300 text-sm 2k:text-xl font-medium uppercase tracking-widest"
                >{{ t('characterSelection.categories.identity') }}</span
              >
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-blue-500/40 flex items-center justify-center"
              >
            ...
            >
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.firstName')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                    characterData[selectedSlot]?.firstName || t('common.unknown')
                  }}</span>
                </div>
                <div
                  class="w-full h-px bg-gradient-to-r from-transparent via-slate-400/70 to-transparent"
                ></div>
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.lastName')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                    characterData[selectedSlot]?.lastName || t('common.unknown')
                  }}</span>
                </div>
              </div>
            </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3 mb-6 justify-end">
              <span
                class="text-slate-300 text-sm 2k:text-xl font-medium uppercase tracking-widest"
                >{{ t('characterSelection.categories.job') }}</span
              >
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-green-500/40 flex items-center justify-center"
              >
            ...
            >
              <div v-if="characterData[selectedSlot]?.job" class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.profession')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                    characterData[selectedSlot]?.job
                  }}</span>
                </div>
                <div
                  class="w-full h-px bg-gradient-to-r from-transparent via-slate-400/70 to-transparent"
                ...
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.grade')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                    characterData[selectedSlot]?.jobGrade
                  }}</span>
                </div>
              </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3 mb-6 justify-end">
              <span
                class="text-slate-300 text-sm 2k:text-xl font-medium uppercase tracking-widest"
                >{{ t('characterSelection.categories.crew') }}</span
              >
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-red-500/40 flex items-center justify-center"
              >
            ...
            >
              <div v-if="characterData[selectedSlot]?.crew" class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.crewName')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                    characterData[selectedSlot]?.crew
                  }}</span>
                </div>
                <div
                  class="w-full h-px bg-gradient-to-r from-transparent via-slate-400/70 to-transparent"
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3 mb-6 justify-end">
              <span
                class="text-slate-300 text-sm 2k:text-xl font-medium uppercase tracking-widest"
                >{{ t('characterSelection.categories.finances') }}</span
              >
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-green-500/40 flex items-center justify-center"
              >
            ...
            >
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.cash')
                  }}</span>
                  <span class="text-green-400 2k:text-lg font-semibold"
                    >{{ characterData[selectedSlot]?.cash?.toLocaleString() || '0' }}$</span
                  >
                </div>
                <div
                  class="w-full h-px bg-gradient-to-r from-transparent via-slate-400/70 to-transparent"
                ...
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.bankAccount')
                  }}</span>
                  <span class="text-blue-400 2k:text-lg font-semibold"
                    >{{ characterData[selectedSlot]?.bank?.toLocaleString() || '0' }}$</span
                  >
                </div>
                <div
                  class="w-full h-px bg-gradient-to-r from-transparent via-slate-400/70 to-transparent"
                ...
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.dirtyMoney')
                  }}</span>
                  <span class="text-red-400 2k:text-lg font-semibold"
                    >{{ characterData[selectedSlot]?.dirtyMoney?.toLocaleString() || '0' }}$</span
                  >
                </div>
              </div>
            </div>
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3 mb-6 justify-end">
              <span
                class="text-slate-300 text-sm 2k:text-xl font-medium uppercase tracking-widest"
                >{{ t('characterSelection.categories.licenses') }}</span
              >
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-purple-500/40 flex items-center justify-center"
              >
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3 mb-6 justify-end">
              <span
                class="text-slate-300 text-sm 2k:text-xl font-medium uppercase tracking-widest"
                >{{ t('characterSelection.categories.stats') }}</span
              >
              <div
                class="w-8 h-8 rounded-lg bg-gradient-to-br from-slate-700 to-slate-800 border border-yellow-500/40 flex items-center justify-center"
              >
            ...
            >
              <div class="space-y-3">
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.totalPlaytime')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                ...
                <div class="flex justify-between items-center">
                  <span class="text-slate-400 text-sm 2k:text-base font-medium">{{
                    t('characterSelection.fields.lastConnection')
                  }}</span>
                  <span class="text-white 2k:text-lg font-semibold">{{
                    characterData[selectedSlot]?.lastPlayed || t('characterSelection.values.never')
                  }}</span>
                </div>
              </div>
            </div>
    ...
    <div class="absolute bottom-24 right-24 z-50">
      <div v-if="selectedSlot && isSlotEmpty">
        ...
        >
          <VIcon start :icon="mdiAccountPlus" class="text-lg" />
      ...
      <div v-if="selectedSlot && !isSlotEmpty" class="space-y-3 flex flex-col">
        <VBtn
          ...
          @click="playCharacter"
        >
          <VIcon start :icon="mdiPlay" class="text-lg" />
