...
local function RegisterAppearanceCallbacks()
  ...
  -- Real-time makeup customization (style, primary color, secondary color, opacity)
  ...
  -- Real-time blush customization (style, color, opacity)
  ...
  -- Real-time complexion customization (style, opacity)
